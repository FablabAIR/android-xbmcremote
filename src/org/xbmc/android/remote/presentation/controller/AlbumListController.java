...
import org.xbmc.android.remote.presentation.activity.NFCWriterActivity;
...
public class AlbumListController extends ListController implements IController {
	...
	public static final int ITEM_CONTEXT_NFC = 4;
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		menu.add(0, ITEM_CONTEXT_NFC, 4, "Add tag NFC");
	}
	...
	public void onContextItemSelected(MenuItem item) {
		...
		System.out.println(album.name + " " + album.artist);
		switch (item.getItemId()) {
			...
			case ITEM_CONTEXT_INFO:
				...
				break;
			case ITEM_CONTEXT_NFC:
				Intent nfcActivity = new Intent(mActivity, NFCWriterActivity.class);
				nfcActivity.putExtra("Album", album);
				nfcActivity.putExtra("type", 0);
				mActivity.startActivity(nfcActivity);
				break;
			default:
				return;
		}
